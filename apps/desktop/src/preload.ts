...
contextBridge.exposeInMainWorld("desktopBridge", {
  ...
  openPathInBrowser: (path: string) =>
    ipcRenderer.invoke(IpcChannels.OPEN_PATH_IN_BROWSER_CHANNEL, path),
  probeRemoteEditors: () => ipcRenderer.invoke(IpcChannels.PROBE_REMOTE_EDITORS_CHANNEL, undefined),
  revealWindow: () => ipcRenderer.invoke(IpcChannels.REVEAL_WINDOW_CHANNEL, undefined),
