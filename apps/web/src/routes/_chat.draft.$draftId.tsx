...
import { threadReadyForDraftRouteHandoff } from "../components/ChatView.logic";
import {
  DraftId,
...
function DraftChatThreadRouteView() {
  ...
  const canonicalThreadRef = threadReadyForDraftRouteHandoff(serverThread) ? serverThreadRef : null;
