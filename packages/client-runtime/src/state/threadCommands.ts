...
import {
  ...
  type SetThreadArtifactReadInput,
  type SetThreadArtifactStarredInput,
  ...
  type ScheduleThreadTurnInput,
  type CancelScheduledThreadTurnInput,
  type ReleaseScheduledThreadTurnInput,
  ...
  setThreadArtifactRead,
  setThreadArtifactStarred,
  ...
  startThreadTurn,
  scheduleThreadTurn,
  cancelScheduledThreadTurn,
  releaseScheduledThreadTurn,
  stopThreadSession,
  unarchiveThread,
  unpinThread,
  unsettleThread,
...
export type {
  ...
  SetThreadArtifactReadInput,
  SetThreadArtifactStarredInput,
  ...
  ScheduleThreadTurnInput,
  CancelScheduledThreadTurnInput,
  ReleaseScheduledThreadTurnInput,
...
export function createThreadEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    setArtifactRead: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:set-artifact-read",
      execute: (input: SetThreadArtifactReadInput) => setThreadArtifactRead(input),
      scheduler,
      concurrency,
    }),
    setArtifactStarred: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:set-artifact-starred",
      execute: (input: SetThreadArtifactStarredInput) => setThreadArtifactStarred(input),
      scheduler,
      concurrency,
    }),
    ...
    scheduleTurn: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:schedule-turn",
      execute: (input: ScheduleThreadTurnInput) => scheduleThreadTurn(input),
      scheduler,
      concurrency,
    }),
    cancelScheduledTurn: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:cancel-scheduled-turn",
      execute: (input: CancelScheduledThreadTurnInput) => cancelScheduledThreadTurn(input),
      scheduler,
      concurrency,
    }),
    releaseScheduledTurn: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:release-scheduled-turn",
      execute: (input: ReleaseScheduledThreadTurnInput) => releaseScheduledThreadTurn(input),
      scheduler,
      concurrency,
    }),
